...
cdef extern from "<lemon/list_graph.h>" namespace "lemon":
  cdef cppclass ListDigraph

cdef extern from "<lemon/list_graph.h>" namespace "lemon::ListDigraph":
  cdef cppclass Arc
  cdef cppclass ArcIt
...
cdef extern from "<lemon/list_graph.h>" namespace "lemon::ListDigraph":
  cdef cppclass ArcIt:
    ...
    inline ArcIt()
    inline ArcIt(ArcIt)
    inline ArcIt(ListDigraph)
    inline ArcIt(ListDigraph, Arc)
...
cdef extern from "<lemon/list_graph.h>" namespace "lemon::ListDigraph":
  cdef cppclass OutArcIt:
    ...
    inline OutArcIt(ListDigraph&)
    inline OutArcIt(ListDigraph&, Arc)
    inline OutArcIt(ListDigraph&, Node)
    inline OutArcIt(ListDigraph&, NodeIt)
...
cdef extern from "<lemon/list_graph.h>" namespace "lemon::ListDigraph":
  cdef cppclass InArcIt:
    ...
    inline InArcIt(ListDigraph&)
    inline InArcIt(ListDigraph&, Arc)
    inline InArcIt(ListDigraph&, Node)
    inline InArcIt(ListDigraph&, NodeItIt)
...
cdef extern from "<lemon/list_graph.h>" namespace "lemon::ListDigraph":
  cdef cppclass NodeIt:
    ...
    inline Node(Node)
    inline NodeIt()
    inline NodeIt(ListDigraph)
    inline NodeIt(ListDigraph,Node)
    inline bint operator!=(Node)
    inline bint operator!=(Invalid)
...
cdef extern from "<lemon/list_graph.h>" namespace "lemon::ListDigraph":
    cdef cppclass Snapshot:
      Snapshot()
      Snapshot(ListDigraph)
      void save(ListDigraph)
      void restore()
